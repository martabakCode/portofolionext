...
export function SiteConfigForm({ initialData }: SiteConfigFormProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setLoading(true);
        try {
            await updateSiteConfigAction(formData);
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <input
                                ...
                                value={formData.primary_color}
                                onChange={handleChange}
                                className="flex-1 bg-zinc-900 border border-zinc-800 rounded-xl p-2 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/50 font-mono text-sm"
                            />
                        </div>
                    </div>
                    <div>
